...
<div class="news-featured">
	<div class="container">
		<div class="row">
			...
			$statement = $pdo->prepare("SELECT * FROM Maleda_News_news WHERE is_featured=1 AND status=? ORDER BY news_id DESC");
...
$statement = $pdo->prepare("SELECT * FROM Maleda_News_advertisement WHERE adv_id=1");
$statement->execute();
$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
foreach ($result as $row) 
{
		...
		<div class="row">
			<div class="col-md-8">
				...
				$statement = $pdo->prepare("SELECT 
				                           ...
				                           FROM Maleda_News_home_category t1
				                           JOIN Maleda_News_category t2
				...
				foreach ($result as $row) 
				{
					...
					<div class="row">
						<div class="col-sm-12 col-md-12">
							...
							$count=0;
							$news_id_arr = array();
							$statement1 = $pdo->prepare("SELECT * FROM Maleda_News_news_category WHERE category_id=? AND access=1");
							...
							$statement1 = $pdo->prepare("SELECT * FROM Maleda_News_news WHERE status=? ORDER BY news_id DESC");

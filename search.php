	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="heading">
					<h2 style="padding:10px;">ይፈልጉ በ: <?php echo $search_string; ?></h2>
				</div>
				...
				$statement = $pdo->prepare("SELECT * FROM Maleda_News_news WHERE status=? AND (news_title like ? OR news_content like ?)");
				...
				<div class="row">
					<div class="col-md-12">
						<p class="not-found">
							ይቅርታ! በፍለጋ ቃልዎ ውስጥ ምንም ዜና አልተገኘም።
						</p>
					</div>
				</div>
				<?php else: ?>

...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['page_name'])) {
    	...
    	$statement = $pdo->prepare("SELECT * FROM Maleda_News_page WHERE page_name=?");
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO Maleda_News_page (page_name,page_slug,page_content,page_layout,status,meta_title,meta_keyword,meta_description) VALUES (?,?,?,?,?,?,?,?)");

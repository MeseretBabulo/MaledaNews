...
$today = date('d-m-Y');
$statement = $pdo->prepare("SELECT * FROM Maleda_News_news_scheduled WHERE news_date=?");
...
if(isset($temp_arr)) {
	for($i=0;$i<count($temp_arr);$i++) {
		$statement = $pdo->prepare("UPDATE Maleda_News_news SET status=? WHERE news_id=?");
...
<head>
	...
	<title>Maleda News - Admin Panel</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Maleda News</span>
			</a>

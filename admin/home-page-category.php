...
if(isset($_POST['form1'])) {
	...
	$statement = $pdo->prepare("UPDATE Maleda_News_home_category SET category_order=?, category_layout=?");
	...
	for($i=0;$i<count($arr1);$i++) {
		if($arr2[$i] != '') {
			$statement = $pdo->prepare("UPDATE Maleda_News_home_category SET category_order=?, category_layout=? WHERE category_id=?");

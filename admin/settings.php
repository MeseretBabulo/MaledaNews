...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("UPDATE Maleda_News_settings SET logo=? WHERE id=1");
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
		$statement = $pdo->prepare("UPDATE Maleda_News_settings SET favicon=? WHERE id=1");
		$statement->execute(array($final_name));
...
if(isset($_POST['form3'])) {
	...
	// updating the database
	$statement = $pdo->prepare("UPDATE Maleda_News_settings SET footer_about=?, footer_copyright=?, contact_address=?, contact_email=?, contact_phone=?, contact_fax=?, contact_map_iframe=? WHERE id=1");
...
if(isset($_POST['form4'])) {
	// updating the database
	$statement = $pdo->prepare("UPDATE Maleda_News_settings SET receive_email=?, receive_email_subject=?,receive_email_thank_you_message=? WHERE id=1");
...
if(isset($_POST['form5'])) {
	// updating the database
	$statement = $pdo->prepare("UPDATE Maleda_News_settings SET total_recent_news=?, total_popular_news=? WHERE id=1");
...
if(isset($_POST['form6'])) {
	// updating the database
	$statement = $pdo->prepare("UPDATE Maleda_News_settings SET meta_title_home=?, meta_keyword_home=?, meta_description_home=? WHERE id=1");
...
if(isset($_POST['form7'])) {
	// updating the database
	$statement = $pdo->prepare("UPDATE Maleda_News_settings SET mod_rewrite=? WHERE id=1");

...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("SHOW TABLE STATUS LIKE 'Maleda_News_photo'");
		$statement->execute();
		...
		$statement = $pdo->prepare("INSERT INTO Maleda_News_photo (photo_caption,photo_name,p_category_id) VALUES (?,?,?)");
